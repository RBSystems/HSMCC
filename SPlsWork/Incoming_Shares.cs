...
namespace UserModule_INCOMING_SHARES
{
    public class UserModuleClass_INCOMING_SHARES : SplusObject
    {
...
public UserModuleClass_INCOMING_SHARES ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
