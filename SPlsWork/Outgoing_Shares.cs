...
namespace UserModule_OUTGOING_SHARES
{
    public class UserModuleClass_OUTGOING_SHARES : SplusObject
    {
    ...
    public UserModuleClass_OUTGOING_SHARES ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
